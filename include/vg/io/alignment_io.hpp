...
gafkluge::GafRecord alignment_to_gaf_old(function<size_t(nid_t)> node_to_length, function<string(nid_t, bool)> node_to_sequence, const Alignment& aln, bool cs_cigar = true, bool base_quals = true, bool frag_links = true);
gafkluge::GafRecord alignment_to_gaf_old(const HandleGraph& graph, const Alignment& aln, bool cs_cigar = true, bool base_quals = true, bool frag_links = true);
